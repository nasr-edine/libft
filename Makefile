...
NAME=libft.a
SRC= srcs/ft_strlen.c srcs/ft_strnlen.c srcs/ft_strchr.c srcs/ft_strrchr.c  srcs/ft_memchr.c srcs/ft_strcpy.c srcs/ft_strcmp.c  srcs/ft_strncmp.c srcs/ft_memcmp.c srcs/ft_memcpy.c srcs/ft_memccpy.c
OBJ= $(SRC:.c=.o)
